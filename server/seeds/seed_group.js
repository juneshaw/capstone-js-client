...
exports.seed = function(knex, Promise) {
  return Promise.join(
    ...
    knex('group').insert({id: 3,
      ...
      host_id: 1,
      bio: "These are cousins from the Murphy side of my family.  There are 6 of us that live in the Denver metro area.  Family reunions stopped a while back, but we want to catch up every now and then!", preference_id: 3})
  );
};
